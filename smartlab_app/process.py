            ...
            if count == 10:
                ...
                for process in f.Win32_Process():
                    ...
                    if process.Name in rlist:
                        ...
                        myScreenshot.save("static/media/"+fnm + ".jpg")
                        ...
                        _, frame1 = cap.read()
                        _, frame1 = cap.read()
                        cv2.imwrite("static/media/s" + fnm + ".jpg", frame1)
                        cap.release()

                        with open("static/media/"+fnm + ".jpg", "rb") as image2string:
                            ...
                            requests.post("http://192.168.29.39:8000/up", params=myobj)
                        with open("static/media/s" + fnm + ".jpg", "rb") as image2string:
                            image_string = base64.b64encode(image2string.read())
                            # f = myScreenshot.read()
                            # print (f)
                            # image_string = base64.b64encode(f)
                            ...
                            requests.post("http://192.168.29.39:8000/up1", params=myobj)
                        break
                count=0
            qrr = requests.get("http://192.168.29.166:5001/process?p="+str(self.sid))
            ...
            for proc in psutil.process_iter():
                ...
                try:
                    ...
                    if  "sd" in lis:
                        ...
                        for i in p:
                         qrr = requests.get("http://192.168.29.39:8000/insprocess?p=" + str(self.sid)+"&pr="+i)
                        # db=Db()
